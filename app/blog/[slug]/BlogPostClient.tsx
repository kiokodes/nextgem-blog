...
const ptComponents = {
  ...
  types: {
    image: ({ value }: any) => {
      ...
      return (
        <img
          src={`https://cdn.sanity.io/images/6l4myqih/production/${imgId}?w=740&auto=format`}
          alt={value.alt || ''}
          loading="lazy"
...
export default function BlogPostClient({ post, recent, slug }: BlogPostClientProps) {
  ...
  const [popupAmount, setPopupAmount] = useState(100000)
        ...
        <div className="container">
          <div className="nav-inner">
            <a href={SITE} className="nav-logo">
              <img src="https://nextgem.sirv.com/assets/logo.png" alt="NextGEM Foundation Logo" />
            </a>
            ...
            <div className="donate-popup-card">
              ...
              <div className="popup-freq">
                <button
                  ...
                  onClick={() => { setPopupFreq('monthly'); setPopupAmount(100000); setCustomAmt('') }}
                >Monthly</button>
                <button
                  className={`popup-freq-btn${popupFreq === 'one-time' ? ' active' : ''}`}
                  onClick={() => { setPopupFreq('one-time'); setPopupAmount(10000); setCustomAmt('') }}
                >One-Time</button>
              </div>
              <div className="popup-amounts">
                {(popupFreq === 'monthly' ? [50000, 100000, 200000] : [5000, 10000, 20000]).map(amt => (
                  <div
                    key={amt}
          ...
          <div className="footer-grid">
            <div>
              <div className="footer-brand-logo">
                <img src="https://nextgem.sirv.com/assets/logo.png" alt="NextGEM Logo" />
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><Link href="/">Share the Story</Link></li>
